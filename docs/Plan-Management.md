...
### Shareable plan  
If you purchase any offer from a shareable plan it will create a new subscription, if you already have that subscription it will just increase the number of quantity of that. In shareable plan you can share the offers between  normal offers and composite offer. C3 suggest to use Shareable plan if you need a composite offer inside a plan.
### Add new plan  
